...
export const HeroButton = tw.button`flex justify-center w-fit mx-auto text-xl sm:text-2xl pb-2 pt-3 px-4 border-3 border-white rounded-3xl hover:bg-black hover:bg-opacity-10 duration-200 z-0`;
