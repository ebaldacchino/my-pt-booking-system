...
export const HeroButton = tw.button`flex justify-center w-[fit-content] mx-auto text-xl sm:text-2xl pb-2 pt-3 px-4 border-[3px] border-white rounded-3xl hover:(bg-black bg-opacity-30) focus:(outline-none bg-black bg-opacity-50) active:(bg-opacity-70 scale-95) duration-200 z-0`;
